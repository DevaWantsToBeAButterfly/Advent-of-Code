...
testBoard = [22, 13, 17, 11, 0, 8, 2, 23, 4, 24, 21, 9, 14, 16, 7, 6, 10, 3, 18, 5, 1, 12, 20, 15, 19, 3, 15, 0, 2, 22, 9, 18, 13, 17, 5, 19, 8, 7, 25, 23, 20, 11, 10, 24, 4, 14, 21, 16, 12, 6, 14, 21, 17, 24, 4, 10, 16, 15, 9, 19, 18, 8, 23, 26, 20, 22, 11, 13, 6, 5, 2, 0, 12, 3, 7]

boardSize = 25
boardSideLength = Math.sqrt(boardSize)
gameEnded = false
	...
	for (board of boards) {
		if (board.numbers.includes(drawnNumber)) {
			...
			if (board.rowScores[cellRow] === 5 || board.colScores[cellCol] === 5) {
				...
				console.log('No winner yet! Let\'s play another round')
			}
		}
	}
}
...
function endGame(winner) {
	console.log('Game Over! The winning board is number ' + winner.id)
	gameEnded = true
	countScore(winner)
}
